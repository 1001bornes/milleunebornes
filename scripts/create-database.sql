...
INSERT INTO "randonnees"
  ("description", "create_time", "statut", "reconnaissance_time", "programmation_time", "is_programmation_speciale", "lieu_depart", "is_lieu_depart_special",
   "cout_euros", "distance_km", "denivele_m", "type_rando", "id_openrunner", "localisation", "note_speciale")
  VALUES
    ('Rando de la Vallée de la Loire1', '2023-01-01 10:00:00', 'Programmée', '2023-01-02 10:00:00', '2023-01-03 10:00:00', true, 'Chalonnes-sur-Loire', true,
    5.0, 20, 200, 'Pédestre', 20656589, 'Limours', 'Note speciale'),
    ('Rando de la Vallée de la Loire1', '2023-01-01 10:00:00', 'Programmée', '2023-02-02 10:00:00', '2023-03-03 10:00:00', false, 'Chalonnes-sur-Loire', false,
    7.0, 15, 200, 'Pédestre', 20656589, 'Limours', null);
-- COMMENT ON COLUMN randonnees.description IS '';
DROP TYPE IF EXISTS "roles_randonnee";
CREATE TYPE "roles_randonnee" AS ENUM (
    'Concepteur',
    'Reconnaisseur',
    'Participant'
);

DROP TABLE IF EXISTS "randonnees_users";
CREATE TABLE "randonnees_users" (
    "randonnee_id" INT NOT NULL,
    "user_id" TEXT NOT NULL,
    "role_randonnee" roles_randonnee,
    PRIMARY KEY ("randonnee_id", "user_id"),
    FOREIGN KEY ("randonnee_id") REFERENCES "randonnees"("id") ON DELETE CASCADE,
    FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE
 );

 INSERT INTO "randonnees_users"
  ("randonnee_id", "user_id", "role_randonnee")
  VALUES
    (1, 1, 'Concepteur'),
    (1, 2, 'Reconnaisseur'),
    (1, 3, 'Participant'),
