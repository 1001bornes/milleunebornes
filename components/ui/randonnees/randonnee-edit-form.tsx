...
export default function RandonneeEditForm({
    ...
    action?: ((values: SelectRandonnee) => void | Promise<void>)
    isAnimateur: boolean;
}>) {
    ...
    function convertInputValue(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>, type: string, value: any) {
    ...
    function handleChange(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) {
        ...
        setForm((prev) => ({
            ...prev,
            [name]: convertInputValue(e, type, value)
        }));
    }
