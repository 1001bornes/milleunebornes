...
export default function RandonneeCreateForm({
    ...
    return (
        <RandonneeEditForm randonnee={randonnee} allAnimateurs={allAnimateurs} animateurs={animateurs} action={(randonnee) => createRandonnee(randonnee)}  isAnimateur={isAnimateur} />
    );
}
